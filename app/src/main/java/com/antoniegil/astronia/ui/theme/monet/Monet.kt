package com.antoniegil.astronia.ui.theme.monet
...
inline val Number.a2: Color
    @Composable 
    get() = LocalTonalPalettes.current accent2 toDouble()

inline val Number.a3: Color
    @Composable 
    get() = LocalTonalPalettes.current accent3 toDouble()

inline val Number.n1: Color
    @Composable 
    get() = LocalTonalPalettes.current neutral1 toDouble()

inline val Number.n2: Color
    @Composable 
    get() = LocalTonalPalettes.current neutral2 toDouble()
